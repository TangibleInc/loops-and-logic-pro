...
Extend Tangible Loops & Logic with Pro features: third-party plugin integrations - Easy Digital Downloads, Events Calendar, Gravity Forms, LearnDash, LifterLMS, WooCommerce.

Repository: https://github.com/tangibleinc/loops-and-logic-pro
...
```sh
git clone git@github.com:tangibleinc/loops-and-logic-pro.git
